# learning how to work out at the gym: a.00.0[CartPole-v0]
...
for _ in range(100):
    env.render() # renders a 0.2 s (or ms i can't remember right now) moment of the simulation
    ...
    #print('i:', info) # returns debugging information, acts as a verobose flag
    print('-------------------------------------------------------|')
